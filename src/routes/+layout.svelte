...
<div class="grid h-screen w-full pl-[53px]">
	...
	<div class="flex flex-col">
		<header
			class="sticky top-0 z-10 flex items-center gap-1 border-b px-4 h-[57px] bg-background"
		>
			...
			<Button variant="outline" size="sm" class="ml-auto text-sm gap-1.5">
				<Share class="size-3.5" />
				Share
			</Button>
			<Button on:click={toggleMode} variant="outline" size="sm">
				<Sun
					class="rotate-0 scale-100 transition-all h-[1.2rem] w-[1.2rem] dark:-rotate-90 dark:scale-0"
				/>
				<Moon
					class="absolute rotate-90 scale-0 transition-all h-[1.2rem] w-[1.2rem] dark:rotate-0 dark:scale-100"
				/>
		...
		<main class="grid flex-1 gap-4 overflow-auto p-4 md:grid-cols-2 lg:grid-cols-3">
			...
			<div
				class="relative flex h-full flex-col rounded-xl p-4 min-h-[50vh] bg-muted/50 lg:col-span-2"
			>
				<Badge variant="outline" class="absolute top-3 right-3">Output</Badge>
				<div class="flex-1"></div>
				<form
					class="relative overflow-hidden rounded-lg border bg-background focus-within:ring-ring focus-within:ring-1">
					<Label for="message" class="sr-only">Message</Label>
					<Textarea
						id="message"
						placeholder="Type your message here..."
						class="resize-none border-0 p-3 shadow-none min-h-12 focus-visible:ring-0"
					/>
